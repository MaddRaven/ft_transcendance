...
const firstPaddle = new Paddle(-(size_renderer.width / 2) + 150, 0x00ACDD, size_renderer);
const secondPaddle = new Paddle(size_renderer.width / 2 - 150, 0xFB1075, size_renderer);
